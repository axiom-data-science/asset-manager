...
export const postDocument = async <T>({
    ...
    const doc = await postToPostgrest<Omit<IDocument<T>, ***REMOVED***owner_sub***REMOVED*** | ***REMOVED***uuid***REMOVED*** | ***REMOVED***created_at***REMOVED*** | ***REMOVED***updated_at***REMOVED***>, IDocument<T>>({
        table: DOCUMENTS_TABLE,
        body: document,
        token,
        signal
...
export const patchDocument = async ({
    ...
    uuid: string,
    document: Omit<IDocument, ***REMOVED***owner_sub***REMOVED*** | ***REMOVED***updated_at***REMOVED*** | ***REMOVED***created_at***REMOVED***>,
    token: string,
    signal?: AbortSignal
}): Promise<IDocument> => {
    const newFieldOverrideConfig = await patchToPostgrest<Omit<IDocument, ***REMOVED***owner_sub***REMOVED*** | ***REMOVED***updated_at***REMOVED*** | ***REMOVED***created_at***REMOVED***>, IDocument>({
        uuid,
        table: DOCUMENTS_TABLE,
        body: document,
        token,
