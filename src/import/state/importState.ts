...
export type ImportRecordStage =
  ***REMOVED***discovered***REMOVED*** | ***REMOVED***loaded***REMOVED*** | ***REMOVED***validated***REMOVED*** | ***REMOVED***reconciled***REMOVED*** | ***REMOVED***ready***REMOVED*** | ***REMOVED***imported***REMOVED*** | ***REMOVED***related***REMOVED*** | ***REMOVED***failed***REMOVED***
...
export const setLoadedRecords = (
  ...
  recordResults: {
    ...
    ...Object.fromEntries(records.map((record) => [importRecordKey(record), { stage: ***REMOVED***loaded***REMOVED*** }])),
  },
})
...
export const isValidationComplete = (session: ImportSession): boolean =>
  ...
  session.records.every(
    (record) => session.validationResults[importRecordKey(record)] !== undefined
  )

export const canSkipImportTypeStep = (session: ImportSession): boolean =>
  session.selectedObjectType !== undefined &&
  session.schema !== null &&
  isValidationComplete(session)
...
export const setImportConflictAction = (
  ...
  ...session,
  reconciliations:
    session.reconciliations?.map((reconciliation) =>
