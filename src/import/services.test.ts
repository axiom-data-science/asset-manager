...
import { oikosLayer, oikosVectorLayers, oikosVectorModules } from ***REMOVED***./services***REMOVED***
...
describe(***REMOVED***Oikos vector layer imports***REMOVED***, () => {
  ...
  it(***REMOVED***deduplicates modules repeated across layer groups***REMOVED***, async () => {
    vi.stubGlobal(
      ***REMOVED***fetch***REMOVED***,
      vi.fn().mockResolvedValue({
        json: async () => ({
          results: [
            {
              id: 17,
              uuid: ***REMOVED***group-17***REMOVED***,
              label: ***REMOVED***Group 17***REMOVED***,
              source: {
                module_uuid: ***REMOVED***module-1***REMOVED***,
                module_label: ***REMOVED***Module 1***REMOVED***,
                layers: [{ type: ***REMOVED***VECTOR***REMOVED***, uuid: ***REMOVED***layer-17***REMOVED*** }],
              },
            },
            {
              id: 18,
              uuid: ***REMOVED***group-18***REMOVED***,
              label: ***REMOVED***Group 18***REMOVED***,
              source: {
                module_uuid: ***REMOVED***module-1***REMOVED***,
                module_label: ***REMOVED***Module 1***REMOVED***,
                layers: [{ type: ***REMOVED***VECTOR***REMOVED***, uuid: ***REMOVED***layer-18***REMOVED*** }],
              },
            },
          ],
        }),
    ...
    const modules = await oikosVectorModules({ url: ***REMOVED***https://example.test/search***REMOVED*** })

    expect(modules).toEqual([
      expect.objectContaining({ slug: ***REMOVED***module-1***REMOVED***, uuid: ***REMOVED***module-1***REMOVED***, label: ***REMOVED***Module 1***REMOVED*** }),
    ])
  })
})
