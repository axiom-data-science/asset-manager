...
import type { IPostgrestParams, IObjectType } from ***REMOVED***@/types/types***REMOVED***
...
export const postObjectType = async ({
  ...
  const newObjectType = await postToPostgrest<
    Omit<IObjectType, ***REMOVED***owner_sub***REMOVED*** | ***REMOVED***uuid***REMOVED*** | ***REMOVED***created_at***REMOVED*** | ***REMOVED***updated_at***REMOVED***>,
    IObjectType
  >({
    table: OBJECT_TYPES_TABLE,
    body: object_type,
