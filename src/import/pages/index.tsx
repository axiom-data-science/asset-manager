...
import { Checkbox, Input, Loader, Tabs, ViewWithLoader } from ***REMOVED***@axdspub/axiom-ui-utilities***REMOVED***
    ...
    <>
      ...
      <TableVirtuoso
        ...
        itemContent={(index, doc) => (
          <ImportRow {...doc} index={index} onChangeSelected={onChangeSelected} />
        )}
      />
    </>
  )
              ...
              <Tabs
                ...
                tabs={[
                  ...
                  },
                  {
                    ...
                    content: <SelectObjectTypeForImport documents={documents} />,
                  },
                  {
